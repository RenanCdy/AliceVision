...
public:
     ...
     */
    inline dpct::image_wrapper_base_p getTextureObject() const { return _textureObject; }
...
private:
    ...
    dpct::image_wrapper_base_p _textureObject = 0;     //< mipmapped array texture object with normalized coordinates
