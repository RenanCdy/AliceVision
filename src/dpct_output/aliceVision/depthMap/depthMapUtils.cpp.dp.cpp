...
void copyFloat2Map(image::Image<float>& out_mapX, image::Image<float>& out_mapY,
                   const CudaHostMemoryHeap<sycl::float2, 2>& in_map_hmh, const ROI& roi, int downscale)
{
...
void copyFloat2Map(image::Image<float>& out_mapX, image::Image<float>& out_mapY,
                   const CudaDeviceMemoryPitched<sycl::float2, 2>& in_map_dmp, const ROI& roi, int downscale)
{
    // copy float2 map from device pitched memory to host memory
    CudaHostMemoryHeap<sycl::float2, 2> map_hmh(in_map_dmp.getSize());
    map_hmh.copyFrom(in_map_dmp);

    copyFloat2Map(out_mapX, out_mapY, map_hmh, roi, downscale);
}

void writeFloat2Map(int rc, const mvsUtils::MultiViewParams& mp, const mvsUtils::TileParams& tileParams, const ROI& roi,
                    const CudaHostMemoryHeap<sycl::float2, 2>& in_map_hmh, const mvsUtils::EFileType fileTypeX,
                    const mvsUtils::EFileType fileTypeY, int scale, int step, const std::string& name)
{
...
void writeFloat2Map(int rc, const mvsUtils::MultiViewParams& mp, const mvsUtils::TileParams& tileParams, const ROI& roi,
                    const CudaDeviceMemoryPitched<sycl::float2, 2>& in_map_dmp, const mvsUtils::EFileType fileTypeX,
                    const mvsUtils::EFileType fileTypeY, int scale, int step, const std::string& name)
{
    const std::string customSuffix = (name.empty()) ? "" : "_" + name;
    const int scaleStep = scale * step;
...
void writeFloat3Map(int rc, const mvsUtils::MultiViewParams& mp, const mvsUtils::TileParams& tileParams, const ROI& roi,
                    const CudaDeviceMemoryPitched<sycl::float3, 2>& in_map_dmp, const mvsUtils::EFileType fileType,
                    int scale, int step, const std::string& name)
{
  ...
  CudaHostMemoryHeap<sycl::float3, 2> map_hmh(in_map_dmp.getSize());
  map_hmh.copyFrom(in_map_dmp);
...
void writeNormalMap(int rc, const mvsUtils::MultiViewParams& mp, const mvsUtils::TileParams& tileParams, const ROI& roi,
                    const CudaDeviceMemoryPitched<sycl::float3, 2>& in_normalMap_dmp, int scale, int step,
                    const std::string& name)
{
    writeFloat3Map(rc, mp, tileParams, roi, in_normalMap_dmp, mvsUtils::EFileType::normalMap, scale, step, name);
}

void writeNormalMapFiltered(int rc, const mvsUtils::MultiViewParams& mp, const mvsUtils::TileParams& tileParams,
                            const ROI& roi, const CudaDeviceMemoryPitched<sycl::float3, 2>& in_normalMap_dmp, int scale,
...
void writeDepthThicknessMap(int rc, const mvsUtils::MultiViewParams& mp, const mvsUtils::TileParams& tileParams,
                            const ROI& roi, const CudaDeviceMemoryPitched<sycl::float2, 2>& in_depthThicknessMap_dmp,
                            int scale, int step, const std::string& name)
{
...
void writeDepthPixSizeMap(int rc, const mvsUtils::MultiViewParams& mp, const mvsUtils::TileParams& tileParams,
                          const ROI& roi, const CudaDeviceMemoryPitched<sycl::float2, 2>& in_depthPixSize_dmp,
                          int scale, int step, const std::string& name)
{
  const mvsUtils::EFileType fileTypeX = mvsUtils::EFileType::depthMap;
...
void writeDepthSimMap(int rc, const mvsUtils::MultiViewParams& mp, const mvsUtils::TileParams& tileParams,
                      const ROI& roi, const CudaDeviceMemoryPitched<sycl::float2, 2>& in_depthSimMap_dmp, int scale,
                      int step, const std::string& name)
{
  const mvsUtils::EFileType fileTypeX = mvsUtils::EFileType::depthMap;
...
void resetDepthSimMap(CudaHostMemoryHeap<sycl::float2, 2>& inout_depthSimMap_hmh, float depth, float sim)
{
