 ...
 * @param[in] stream the CUDA stream for gpu execution
 */
extern void cuda_gaussianBlurVolumeZ(CudaDeviceMemoryPitched<float, 3>& inout_volume_dmp, int gaussRadius,
                                     dpct::queue_ptr stream);
 ...
 * @param[in] stream the CUDA stream for gpu execution
 */
extern void cuda_gaussianBlurVolumeXYZ(CudaDeviceMemoryPitched<float, 3>& inout_volume_dmp, int gaussRadius,
                                       dpct::queue_ptr stream);
 ...
 */
extern void cuda_medianFilter3(dpct::image_wrapper_base_p tex, CudaDeviceMemoryPitched<float, 2>& img);
