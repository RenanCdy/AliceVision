 ...
 */
extern void cuda_depthSimMapCopyDepthOnly(CudaDeviceMemoryPitched<sycl::float2, 2>& out_depthSimMap_dmp,
                                          const CudaDeviceMemoryPitched<sycl::float2, 2>& in_depthSimMap_dmp,
                                          float defaultSim, dpct::queue_ptr stream);
 ...
 * @param[in] stream the stream for gpu execution
 */
extern void cuda_normalMapUpscale(CudaDeviceMemoryPitched<sycl::float3, 2>& out_upscaledMap_dmp,
 ...
 * @param[in] stream the stream for gpu execution
 */
extern void cuda_depthThicknessSmoothThickness(CudaDeviceMemoryPitched<sycl::float2, 2>& inout_depthThicknessMap_dmp,
                                               const SgmParams& sgmParams, const RefineParams& refineParams,
 ...
 */
extern void
cuda_computeSgmUpscaledDepthPixSizeMap(CudaDeviceMemoryPitched<sycl::float2, 2>& out_upscaledDepthPixSizeMap_dmp,
                                       const CudaDeviceMemoryPitched<sycl::float2, 2>& in_sgmDepthThicknessMap_dmp,
                                       const int rcDeviceCameraParamsId, const DeviceMipmapImage& rcDeviceMipmapImage,
 ...
 * @param[in] stream the stream for gpu execution
 */
extern void cuda_depthSimMapComputeNormal(CudaDeviceMemoryPitched<sycl::float3, 2>& out_normalMap_dmp,
                                          const CudaDeviceMemoryPitched<sycl::float2, 2>& in_depthSimMap_dmp,
 ...
 */
extern void
cuda_depthSimMapOptimizeGradientDescent(CudaDeviceMemoryPitched<sycl::float2, 2>& out_optimizeDepthSimMap_dmp,
